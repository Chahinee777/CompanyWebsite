...
<div class="col-lg-12">
	<div class="card card-outline card-primary">
		<div class="card-header">
			<h5 class="card-title">Informations du Systeme</h5>
		...
		<div class="card-body">
			<form action="" id="system-frm">
				...
				<div class="form-group">
					<label for="name" class="control-label">Nom de Systeme</label>
					<input type="text" class="form-control form-control-sm" name="name" id="name" value="<?php echo $_settings->info('name') ?>">
				</div>
				<div class="form-group">
					<label for="short_name" class="control-label">Nom abrégé du système</label>
					<input type="text" class="form-control form-control-sm" name="short_name" id="short_name" value="<?php echo  $_settings->info('short_name') ?>">
				</div>
			<div class="form-group">
				<label for="" class="control-label">Contenu de bienvenue</label>
			...
			<div class="form-group">
				<label for="" class="control-label">Systeme Logo</label>
			...
			<div class="form-group">
				<label for="" class="control-label">Image de la bannière du site Web</label>
				<div class="custom-file">
