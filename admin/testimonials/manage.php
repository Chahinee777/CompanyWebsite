...
<div class="col-lg-12">
	<div class="card card-outline card-primary">
		...
		<h5 class="card-title"><?php echo isset($id) ? "Manage": "Create" ?> Témoignage</h5>
		</div>
		<div class="card-body">
			<form id="testimonial">
				<div class="row" class="details">
					...
					<div class="col-sm-6">
						<div class="form-group">
							<label for="" class="control-label">Nom de Client (<i>Position, Company/Business Name</i>)</label>
				...
				<div class="row">
					<div class="col-sm-12">
						<div class="form-group">
							<label for="" class="control-label">Témoignage</label>
		...
		<div class="card-footer">
			...
			<a class="btn btn-primary btn-sm" href="./?page=testimonials">Annuler</a>
		</div>
	</div>
</div>
<style>
