			...
			<table class="table tabe-hover table-bordered table-compact" id="list">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<small class=""><b>Sujet:</b> <?php echo $row['subject'] ?></small><br>
							<small class="truncate"><b>Message:</b><?php echo $row['message'] ?></small>
						</td>
						<td class="text-center">
							<?php if($row['status'] == 0): ?>
								<span class="badge badge-primary badge-status">Nouveau</span>
							<?php else: ?>
								<span class="badge badge-success badge-status">Lire</span>
							<?php endif; ?>
						</td>
						<td class="text-center">
		                    <div class="btn-group">
