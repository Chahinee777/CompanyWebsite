...
<div class="col-lg-12">
	<div class="card card-outline card-primary">
			...
			<form id="contact">
				<div class="row">
					<div class="col-sm-6">
						...
						<div class="form-group">
							<label for="" class="control-label">Lien Facebook</label>
							<div class="input-group">
			                    <div class="input-group-prepend">
						...
						<div class="form-group">
							<label for="" class="control-label">Lien Twitter</label>
							<div class="input-group">
			                    <div class="input-group-prepend">
						...
						<div class="form-group">
							<label for="" class="control-label">Lien LinkedIn</label>
							<div class="input-group">
			                    <div class="input-group-prepend">
		...
		<div class="card-footer">
			<button class="btn btn-primary btn-sm" form="contact">Sauvegarder</button>
		</div>
	</div>
</div>
